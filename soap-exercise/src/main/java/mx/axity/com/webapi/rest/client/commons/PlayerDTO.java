...
public class PlayerDTO implements Serializable {
     ...
     */
    public PlayerDTO(String name, String race, String playerClass, int level, int hitPoints, int strength,
     ...
     * @param charisma     Puntuación de carisma del jugador.
     */
    public PlayerDTO(BigInteger id, String name, String race, String playerClass, int level, int hitPoints, int strength,
                  int dexterity, int constitution, int intelligence, int wisdom, int charisma) {
        this.id = id;
        this.name = name;
        this.race = race;
